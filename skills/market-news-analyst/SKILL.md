...
description: This skill should be used when analyzing recent market-moving news events and their impact on equity markets and commodities. Use this skill when the user requests analysis of major financial news from the past 7 days, wants to understand market reactions to monetary policy decisions (FOMC, ECB, BOJ), needs assessment of geopolitical events' impact on commodities, or requires comprehensive review of earnings announcements from mega-cap stocks. The skill automatically collects news using WebSearch/WebFetch tools and produces impact-ranked analysis reports. All analysis thinking and output are conducted in Traditional Chinese.
---
...
This skill enables comprehensive analysis of market-moving news events from the past 7 days, focusing on their impact on US equity markets and commodities. The skill automatically collects news from trusted sources using WebSearch and WebFetch tools, evaluates market impact magnitude, analyzes actual market reactions, and produces structured Traditional Chinese reports ranked by market impact significance.

## When to Use This Skill

Use this skill when:
- User requests analysis of recent major market news (past 7 days)
...
- "Analyze the major market news from the past 7 days"
...
**Objective:** Gather comprehensive news from the past 7 days covering major market-moving events.
...
**Monetary Policy:**
- Search: "FOMC meeting past 7 days", "Federal Reserve interest rate", "ECB policy decision", "Bank of Japan"
...
**Mega-Cap Earnings:**
- Search: "Apple earnings [current quarter]", "Microsoft earnings", "NVIDIA earnings", "Amazon earnings", "Tesla earnings", "Meta earnings", "Google earnings", "TSMC earnings", "AMD earnings"
...
- Collect publication dates to ensure news is within 7-day window
...
Think in Traditional Chinese throughout collection process. Document each significant news item with:
- Date and time
...
When multiple significant events occurred in the 7-day period, assess interactions:
...
**Objective:** Create structured Traditional Chinese Markdown report ranked by market impact.
...
[Identify overarching theme across the 7-day period]
...
*Analysis Thinking: Traditional Chinese*
...
- Maintain consistent Traditional Chinese throughout
...
10. **Traditional Chinese Consistency:** All thinking, analysis, and output in Traditional Chinese for consistency
...
- Recommended search strategies for 7-day analysis
- Source credibility framework
- Red flag sources to avoid

## Important Notes

- All analysis thinking must be conducted in Traditional Chinese
- All output Markdown files must be in Traditional Chinese
...
- Target analysis period: Past 7 days from current date
